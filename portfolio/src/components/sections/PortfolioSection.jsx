...
// Move portfolioProjects array outside the component to avoid recreation on each render
...
// Memoize PortfolioCard to avoid unnecessary re-renders
        ...
        >
          {portfolioProjects.map((project, index) => (
            <PortfolioCard
              key={index}
              {...project}
              isVisible={isMobile ? true : isPortfolioVisible}
            />
          ))}
        </div>
